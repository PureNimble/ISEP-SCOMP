...
a)
    ...
    A: Não, na lista de processos apenas aparece o processo pai e o primeiro processo que se transformou num processo zombie, ou seja,
       das duas uma, ou terminou antes do seu processo pai ou foi "morto" durante a execução e o seu pai (ainda a executar) não reparou.
...
b) 
    ...
    A: Sim, tal como disse na resposta anterior, o processo 1 transformou-se num processo zombie, o que significa que ou terminou primeiro do que
       o processo pai ou foi "morto" durante a sua execução e o seu pai que ainda estava em execução não reparou.
